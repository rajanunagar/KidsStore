			...
			<div class="row">
				...
				<div class="col-sm-6">
					<div class="shopping-item">
						<a href="cart">Cart - <span class="cart-amunt">Rs. ${total }</span> <i
							class="fa fa-shopping-cart"></i> <span class="product-count">${totalproducts }</span></a>
					</div>
				</div>
			</div>
		</div>
        ...
        <div class="checkout">
            <div class="container">
                <div class="table-responsive">
                    <table class="table table-bordered" id="customers"style="border:10px">
                        <thead>
                            <tr>
                                <th>SR.No</th>
                                <th>Order No</th>
                        ...
                        <%
/*                             List<CartList> cartlist=o.getCart().getProduct();
