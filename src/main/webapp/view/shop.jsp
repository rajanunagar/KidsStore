...
<html lang="en">
  <head>
    ...
    <title>Shop Page- KidsStore</title>
...
.closebtn:hover {
  ...
  <body>
   ...
   if(added!=null && added.equals("yes")){
	   ...
	   out.print("<div class='success'><span class='closebtn' onclick='this.parentElement.style.display='none';'>&times;</span>Success! Product added to cart successfully</div>");

   }
   if(available!=null && available.equals("no")){
	   session.removeAttribute("available");

	   out.print("<div class='alert'><span class='closebtn' onclick='this.parentElement.style.display='none';'>&times;</span>Sorry! Product is not available</div>");
   }
   %>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="./">Home</a></li>
                        <li class="active"><a href="shop?type=${type}">Shop page</a></li>
